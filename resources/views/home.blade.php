    ...
    <div class="homepage" id="homepage_div_id" style="display:block">
            ...
            <div class = "displayBox" id="displayBox_id" onload="change()">
                <div class="displayBox_bd">
                    <ul>
                        <img src="{{URL::asset('/image/1.jpg') }}" width=80% height=450px>
                        <img src="{{URL::asset('/image/2.jpg') }}" width=80% height=450px>
                        <img src="{{URL::asset('/image/3.jpg') }}" width=80% height=450px>
                    </ul>
                </div>
            </div>
